...
public class Lessons60058 {
    ...
    public static String part(String p){
        ...
        if(check(u)) result.append(u).append(part(v));
        else result.append("(").append(part(v)).append(")").append(removeReverse(u));

        return result.toString();
    }

    public static String removeReverse(String u){
