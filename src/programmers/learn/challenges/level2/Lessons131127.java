...
public class Lessons131127 {
    ...
    public static void main(String[] args) throws Exception {
        String[] arr = {"banana", "apple", "rice", "pork", "pot"};
        int[] arr2 = {3, 2, 2, 2, 1};
        String[] arr3 = {"chicken", "apple", "apple", "banana", "rice", "apple", "pork", "banana", "pork", "rice", "pot", "banana", "apple", "banana"};

        long s = System.currentTimeMillis();
        System.err.println( solution(arr, arr2, arr3) );
    ...
    public static int solution(String[] want, int[] number, String[] discount) {
        ...
        for(int i=0; i<=discount.length-10; i++){
            String[] arr2 = Arrays.copyOfRange(discount, i, i+10);
            Arrays.sort(arr2);
            if(Arrays.equals(arr, arr2)) cnt++;
        }
        return cnt;
    }
}
...
예를 들어, 정현이가 원하는 제품이 바나나 3개, 사과 2개, 쌀 2개, 돼지고기 2개, 냄비 1개이며, XYZ 마트에서 15일간 회원을 대상으로 할인하는
