...
public class Problem1389 {
    ...
    public static void main(String args[]) throws Exception {
        ...
        int index = 0;
        for(int i=1; i<=n; i++){
            int cnt = Arrays.stream(bfs(n, i, arr)).sum();
    ...
    public static int[] bfs(int n, int start, List<Integer>[] arr){
...
2 초	128 MB	26637	14847	11657	55.941%
문제
...
최백준과 김선영은 같이 Startlink를 창업했다. 김선영과 김도현은 같은 학교 동아리 소속이다. 김도현과 민세희는 같은 학교에 다니는 사이로 서로 알고 있다.
