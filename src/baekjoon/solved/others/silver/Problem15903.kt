...
1 초 (추가 시간 없음)	512 MB	12859	5587	4659	43.275%
...
3. 이 카드 합체를 총 m번 하면 놀이가 끝난다. m번의 합체를 모두 끝낸 뒤, n장의 카드에 쓰여있는 수를 모두 더한 값이 이 놀이의 점수가 된다.
...
19
출처
University > 전국 대학생 프로그래밍 대회 동아리 연합 > UCPC 2018 예선 B번
